...
_RE_FECHA = _re.compile(r"/Date\((-?\d+)")     # el formato de fecha de Xero
...
# ⚠️ Un pago en Xero solo se aplica a una factura APROBADA (o ya pagada). Una en
...
def de_fecha(valor):
    ...
    """
    m = _RE_FECHA.search(str(valor or ""))
    if m:
