...
Doble guarda: el ID tiene que estar en creado_v487prod.json Y la fila tiene que llevar
...
with io.open(os.path.join(AQUI, "creado_v487prod.json"), encoding="utf-8") as f:
    creado = json.load(f)
